...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card-header" style="text-align: center; padding-bottom: 3%; font-size: 26px; color: #000000">Add Designation<a href="{{route('designations')}}" class="btn btn-success" style="float:right">Back</a></div>
