...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
	  ...
	  <div class="content-wrapper" style="margin-left: 0px; background: none;min-height: auto !important;">
	    ...
	    <section class="content-header" style="background: #ffffff8c; padding: unset !important;">
	      <div class="container-fluid">
	        <div class="row">
	          <div class="col-sm-12">
		        ...
		        <div class="col-md-5" style="opacity: 0.95;border-radius: 5px;background: #ffffff33;">
		          ...
		          <div class="card card-primary">
		           ...
		           <form action="{{route('verifyOtp')}}" method="post" enctype="multipart/form-data" > 
		            	@csrf
		              	<div class="card-body">
		              		<center><p>Check Your Mail Inbox!!</p></center>
                          ...
                          <input type="hidden" name="user_id" value="{{ $user_id }}">
			                 ...
			                 <div class="form-group">
			                    ...
			                    <input autocomplete="off" class="form-control" data-val="true" data-val-length-max="6" data-val-length-min="6"  id="otp" name="otp" placeholder="Enter Otp here" type="number" value="" step="0.01"/>
			                    <span class="field-validation-valid text-danger" data-valmsg-for="otp" data-valmsg-replace="true"></span>
			                </div>
				            <!-- Google reCaptcha v2 -->
					       {!! htmlFormSnippet() !!}
			                ...
			                <div class="row">
			                    <div style="margin-bottom: 15px;" class="col-md-12">
			                        <center>
			                            ...
			                            <!-- <a style="margin-left: 10px;" href="{{route('registration')}}"><button type="button" class="btn btn-success btn-sm">Create account</button></a> -->
			                        </center>
			                    </div>
			                </div>
		              	</div>
