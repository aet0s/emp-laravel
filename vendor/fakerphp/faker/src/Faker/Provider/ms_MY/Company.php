...
class Company extends \Faker\Provider\Company
{
    ...
    protected static $companies = [
        ...
        'Magnum Corporation', 'Maybank', 'Malaysia Airlines', 'Malaysia emp-laravel-employe-portals', 'Marrybrown', 'Maxis Communications', 'MBO Cinemas', 'Media Prima', 'MIMOS', 'MISC', 'Modenas', 'MUI Group', 'Mydin',
